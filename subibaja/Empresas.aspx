<%@ Page Title="Subibaje :: Niveles" Language="C#" MasterPageFile="~/App.Master" AutoEventWireup="true" CodeBehind="Empresas.aspx.cs" Inherits="subibaja.Empresas" %>
...
<asp:Content ID="muestraNiveles" ContentPlaceHolderID="contenido" Runat="Server">
    ...
    <asp:GridView EmptyDataText="No hay niveles empresas cargadas" 
