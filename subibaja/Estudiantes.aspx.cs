...
namespace subibaja
{
    public partial class Estudiantes : Pagina
    {
        ...
        protected void grdEstudiantes_RowDeleting(object sender, GridViewDeleteEventArgs e)
        {
            _wrapperError.Style.Add("display", "none");

            try
            {
                int id = Convert.ToInt32(grdEstudiantes.DataKeys[e.RowIndex].Value.ToString());
