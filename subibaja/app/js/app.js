...
-1 !== i.indexOf(e.type) && (u = t.querySelector(".sa-icon.sa-" + e.type), s.show(u));
    ...
    slider = $("#slider").slideReveal({
        ...
        show: function (obj) {
            ...
            $('.cambiarToggle').fadeToggle(),
            $("#main-container").addClass("disabled"), $(".btn-fab").animate({
                right: "+=200"
            }, 500);
        },
        shown: function (obj) { },
        hide: function (obj) {
            ...
            $('.cambiarToggle').fadeToggle(),
            $("#main-container").removeClass("disabled"), $(".btn-fab").animate({
                right: "-=200"
            }, 500);
        },
        hidden: function (obj) { }
...
if (sorttable = {
    ...
    makeSortable: function(table) {
        ...
        1 == table.tHead.rows.length) {
            ...
            mtch && (override = mtch[1]), mtch && "function" == typeof sorttable["sort_" + override] ? headrow[i].sorttable_sortfunction = sorttable["sort_" + override] : headrow[i].sorttable_sortfunction = sorttable.guessType(table, i), 
    ...
    sort_ddmm: function(a, b) {
        ...
        1 == d.length && (d = "0" + d), dt2 = y + m + d, dt1 == dt2 ? 0 : dt1 < dt2 ? -1 : 1;
    },
