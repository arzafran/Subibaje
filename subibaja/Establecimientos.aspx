...
<asp:Content ID="muestraEstablecimientos" ContentPlaceHolderID="contenido" Runat="Server">
    ...
    <asp:GridView EmptyDataText="No hay establecimientos cargadas" OnRowDeleting="grdEstablecimientos_RowDeleting"
        CssClass="table table-condensed table-hover sortable" ID="grdEstablecimientos" runat="server" 
        GridLines="None" AutoGenerateColumns="false" DataKeyNames="id" 
        onrowcommand="grdEstablecimientos_RowCommand" OnRowDataBound="grdEstablecimientos_RowDataBound">
        <Columns>
            <asp:BoundField DataField="id" HeaderText="Id" />
            <asp:BoundField DataField="nombre" HeaderText="Nombre" />
            <asp:BoundField DataField="Ciudad" HeaderText="Ciudad" />
            <asp:BoundField DataField="Niveles" HeaderText="Niveles" />
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-1">
                            <asp:RequiredFieldValidator ID="requiredCiudades" runat="server" CssClass="validadores"
                                ErrorMessage="La ciudad es obligatoria" SetFocusOnError="True"
                                ControlToValidate="ddlCiudades">*</asp:RequiredFieldValidator>
                        </div>
                    </div>
                    <div class="form-group">
                        <asp:Panel CssClass="col-sm-9 col-sm-offset-2" ID="Panel1" runat="server">
                            <asp:CheckBoxList ID="ckNiveles" DataTextField="Nombre" DataValueField="Id" runat="server">
                            </asp:CheckBoxList>
                        </asp:Panel>
                    </div>
                    <div class="form-group">
