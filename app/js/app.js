if (window.Modernizr = function(window, document, undefined) {
    ...
    function rn(e, t) {
        for (var n, r, i, o = [], a = 0, s = e.length; s > a; a++) r = e[a], r.style && (o[a] = b._data(r, "olddisplay"), 
        n = r.style.display, t ? (o[a] || "none" !== n || (r.style.display = ""), "" === r.style.display && nn(r) && (o[a] = b._data(r, "olddisplay", un(r.nodeName)))) : o[a] || (i = nn(r), 
    ...
    function an(e, t, n, r, i) {
        for (var o = n === (r ? "border" : "content") ? 4 : "width" === t ? 1 : 0, a = 0; 4 > o; o += 2) "margin" === n && (a += b.css(e, n + Zt[o], !0, i)), 
        r ? ("content" === n && (a -= b.css(e, "padding" + Zt[o], !0, i)), "margin" !== n && (a -= b.css(e, "border" + Zt[o] + "Width", !0, i))) : (a += b.css(e, "padding" + Zt[o], !0, i), 
    ...
    function Hn(e) {
        return function(t, n) {
            ...
            if (b.isFunction(n)) for (;r = o[i++]; ) "+" === r[0] ? (r = r.slice(1) || "*", 
    ...
    function Zn(e, t) {
        b.each(t, function(t, n) {
            for (var r = (Qn[t] || []).concat(Qn["*"]), i = 0, o = r.length; o > i; i++) if (r[i].call(e, t, n)) return;
        });
    }
    function er(e, t, n) {
    ...
    b.Callbacks = function(e) {
        ...
        var n, r, i, o, a, s, u = [], l = !e.once && [], c = function(t) {
            ...
            remove: function() {
                return u && b.each(arguments, function(e, t) {
                    for (var r; (r = b.inArray(t, u, r)) > -1; ) u.splice(r, 1), n && (o >= r && o--, 
                    a >= r && a--);
                }), this;
            },
            has: function(e) {
        ...
        when: function(e) {
            var s, u, l, t = 0, n = h.call(arguments), r = n.length, i = 1 !== r || e && b.isFunction(e.promise) ? r : 0, o = 1 === i ? e : b.Deferred(), a = function(e, t, n) {
                return function(r) {
    ...
    b.extend({
        ...
        promise: function(e, n) {
            ...
            for ("string" != typeof e && (n = e, e = t), e = e || "fx"; s--; ) r = b._data(a[s], e + "queueHooks"), 
    ...
    b.fn.extend({
        ...
        toggleClass: function(e, t) {
            ...
            return b.isFunction(e) ? this.each(function(n) {
                ...
                if ("string" === n) for (var o, a = 0, s = b(this), u = t, l = e.match(w) || []; o = l[a++]; ) u = r ? u : !s.hasClass(o), 
                s[u ? "addClass" : "removeClass"](o); else (n === i || "boolean" === n) && (this.className && b._data(this, "__className__", this.className), 
        ...
        val: function(e) {
            ...
            })) : o ? (r = b.valHooks[o.type] || b.valHooks[o.nodeName.toLowerCase()], r && "get" in r && (n = r.get(o, "value")) !== t ? n : (n = o.value, 
            "string" == typeof n ? n.replace(U, "") : null == n ? "" : n)) : void 0;
        }
    }), b.extend({
        valHooks: {
            option: {
        ...
        attr: function(e, n, r) {
            ...
            return e && 3 !== u && 8 !== u && 2 !== u ? typeof e.getAttribute === i ? b.prop(e, n, r) : (a = 1 !== u || !b.isXMLDoc(e), 
            ...
            r) : (b.removeAttr(e, n), t)) : void 0;
        },
        removeAttr: function(e, t) {
            var n, r, i = 0, o = t && t.match(w);
            if (o && 1 === e.nodeType) for (;n = o[i++]; ) r = b.propFix[n] || n, J.test(n) ? !Q && G.test(n) ? e[b.camelCase("default-" + n)] = e[r] = !1 : e[r] = !1 : b.attr(e, n, ""), 
        ...
        prop: function(e, n, r) {
            ...
            return e && 3 !== s && 8 !== s && 2 !== s ? (a = 1 !== s || !b.isXMLDoc(e), a && (n = b.propFix[n] || n, 
            o = b.propHooks[n]), r !== t ? o && "set" in o && (i = o.set(e, r, n)) !== t ? i : e[n] = r : o && "get" in o && null !== (i = o.get(e, n)) ? i : e[n]) : void 0;
        },
        propHooks: {
            tabIndex: {
                get: function(e) {
    ...
    b.event = {
        ...
        add: function(e, n, r, o, a) {
            ...
            if (v) {
                for (r.handler && (c = r, r = c.handler, a = c.selector), r.guid || (r.guid = b.guid++), 
                (u = v.events) || (u = v.events = {}), (f = v.handle) || (f = v.handle = function(e) {
                    return typeof b === i || e && b.event.triggered === e.type ? t : b.event.dispatch.apply(f.elem, arguments);
                }, f.elem = e), n = (n || "").match(w) || [ "" ], l = n.length; l--; ) s = rt.exec(n[l]) || [], 
        ...
        remove: function(e, t, n, r, i) {
            ...
            if (m && (c = m.events)) {
                for (t = (t || "").match(w) || [ "" ], l = t.length; l--; ) if (s = rt.exec(t[l]) || [], 
                d = g = s[1], h = (s[2] || "").split(".").sort(), d) {
                    for (p = b.event.special[d] || {}, d = (r ? p.delegateType : p.bindType) || d, f = c[d] || [], 
                    s = s[2] && RegExp("(^|\\.)" + h.join("\\.(?:.*\\.|)") + "(\\.|$)"), u = o = f.length; o--; ) a = f[o], 
        ...
        trigger: function(n, r, i, a) {
            ...
            p = b.event.special[g] || {}, a || !p.trigger || p.trigger.apply(i, r) !== !1)) {
                ...
                for (d = 0; (l = h[d++]) && !n.isPropagationStopped(); ) n.type = d > 1 ? c : p.bindType || g, 
        ...
        dispatch: function(e) {
            ...
            if (u[0] = e, e.delegateTarget = this, !c.preDispatch || c.preDispatch.call(this, e) !== !1) {
                for (s = b.event.handlers.call(this, e, l), n = 0; (o = s[n++]) && !e.isPropagationStopped(); ) for (e.currentTarget = o.elem, 
        ...
        fix: function(e) {
            ...
            r = s.props ? this.props.concat(s.props) : this.props, e = new b.Event(a), t = r.length; t--; ) n = r[t], 
            e[n] = a[n];
            ...
            if (!d && !r) {
                ...
                if (T.qsa && !h.test(e)) {
                    if (f = !0, g = x, m = t, v = 9 === s && e, 1 === s && "object" !== t.nodeName.toLowerCase()) {
                        for (l = ft(e), (f = t.getAttribute("id")) ? g = f.replace(K, "\\$&") : t.setAttribute("id", g), 
                        g = "[id='" + g + "'] ", u = l.length; u--; ) l[u] = g + dt(l[u]);
        ...
        function ht(e, t, n) {
            ...
            return t.first ? function(t, n, r) {
                ...
                } else for (;t = t[i]; ) if (1 === t.nodeType || o) if (c = t[x] || (t[x] = {}), 
                (l = c[i]) && l[0] === p) {
        ...
        function yt(e, t, n, r, i, o) {
            return r && !r[x] && (r = yt(r)), i && !i[x] && (i = yt(i, o)), ot(function(o, a, s, u) {
                ...
                if (n && n(m, y, s, u), r) for (l = mt(y, d), r(l, [], s, u), c = l.length; c--; ) (p = l[c]) && (y[d[c]] = !(m[d[c]] = p));
                if (o) {
                    if (i || e) {
                        if (i) {
        ...
        function vt(e) {
            ...
            } ]; o > u; u++) if (n = i.relative[e[u].type]) f = [ ht(gt(f), n) ]; else {
        ...
        function bt(e, t) {
            var n = 0, o = t.length > 0, a = e.length > 0, s = function(s, u, c, f, d) {
                ...
                if (v += b, o && b !== v) {
                    ...
                    if (s) {
                        if (v > 0) for (;b--; ) x[b] || y[b] || (y[b] = L.call(f));
                        y = mt(y);
                    }
        ...
        function wt(e, t, n, r) {
            ...
            if (!r && 1 === p.length) {
                ...
                for (o = U.needsContext.test(e) ? 0 : a.length; o-- && (u = a[o], !i.relative[l = u.type]); ) if ((c = i.find[l]) && (r = c(u.matches[0].replace(et, tt), V.test(a[0].type) && t.parentNode || t))) {
                    ...
                    return 1 === r && 0 === i ? function(e) {
                        ...
                        if (m) {
                            ...
                            if (h = [ a ? m.firstChild : m.lastChild ], a && v) {
                                for (c = m[x] || (m[x] = {}), l = c[e] || [], d = l[0] === N && l[1], f = l[0] === N && l[2], 
                                p = d && m.childNodes[d]; p = ++d && p && p[g] || (f = d = 0) || h.pop(); ) if (1 === p.nodeType && ++f && p === t) {
                                    c[e] = [ N, d, f ];
                                    break;
                                }
                            } else if (v && (l = (t[x] || (t[x] = {}))[e]) && l[0] === N) f = l[1]; else for (;(p = ++d && p && p[g] || (f = d = 0) || h.pop()) && ((s ? p.nodeName.toLowerCase() !== y : 1 !== p.nodeType) || !++f || (v && ((p[x] || (p[x] = {}))[e] = [ N, f ]), 
                            p !== t)); ) ;
        ...
        s = st.compile = function(e, t) {
            ...
            return o;
        }, i.pseudos.nth = i.pseudos.eq, i.filters = Tt.prototype = i.pseudos, i.setFilters = new Tt(), 
        c(), st.attr = b.attr, b.find = st, b.expr = st.selectors, b.expr[":"] = b.expr.pseudos, 
        b.unique = st.uniqueSort, b.text = st.getText, b.isXMLDoc = st.isXML, b.contains = st.contains;
    }(e);
    ...
    b.fn.extend({
        ...
        closest: function(e, t) {
            for (var n, r = 0, i = this.length, o = [], a = lt.test(e) || "string" != typeof e ? b(e, t || this.context) : 0; i > r; r++) for (n = this[r]; n && n.ownerDocument && n !== t && 11 !== n.nodeType; ) {
    ...
    At.th = At.td, b.fn.extend({
        ...
        remove: function(e, t) {
            for (var n, r = 0; null != (n = this[r]); r++) (!e || b.filter(e, [ n ]).length > 0) && (t || 1 !== n.nodeType || b.cleanData(Ot(n)), 
        ...
        b.fn[e] = function(e) {
            for (var n, r = 0, i = [], o = b(e), a = o.length - 1; a >= r; r++) n = r === a ? this : this.clone(!0), 
            b(o[r])[t](n), d.apply(i, n.get());
        ...
        buildFragment: function(e, t, n, r) {
            for (var i, o, a, s, u, l, c, p = e.length, f = dt(t), d = [], h = 0; p > h; h++) if (o = e[h], 
            o || 0 === o) if ("object" === b.type(o)) b.merge(d, o.nodeType ? [ o ] : o); else if (wt.test(o)) {
                for (s = s || f.appendChild(t.createElement("div")), u = (bt.exec(o) || [ "", "" ])[1].toLowerCase(), 
                ...
                !b.support.tbody) for (o = "table" !== u || xt.test(o) ? "<table>" !== c[1] || xt.test(o) ? 0 : s : s.firstChild, 
                i = o && o.childNodes.length; i--; ) b.nodeName(l = o.childNodes[i], "tbody") && !l.childNodes.length && o.removeChild(l);
                for (b.merge(d, s.childNodes), s.textContent = ""; s.firstChild; ) s.removeChild(s.firstChild);
                s = f.lastChild;
            } else d.push(t.createTextNode(o));
            for (s && f.removeChild(s), b.support.appendChecked || b.grep(Ot(d, "input"), Bt), 
            h = 0; o = d[h++]; ) if ((!r || -1 === b.inArray(o, r)) && (a = b.contains(o.ownerDocument, o), 
            s = Ot(f.appendChild(o), "script"), a && Mt(s), n)) for (i = 0; o = s[i++]; ) kt.test(o.type || "") && n.push(o);
            return s = null, f;
        },
        cleanData: function(e, t) {
            for (var n, r, o, a, s = 0, u = b.expando, l = b.cache, p = b.support.deleteExpando, f = b.event.special; null != (n = e[s]); s++) if ((t || b.acceptData(n)) && (o = n[u], 
            a = o && l[o])) {
    ...
    b.Animation = b.extend(er, {
        ...
        return s ? (n = s.documentElement, b.contains(n, a) ? (typeof a.getBoundingClientRect !== i && (o = a.getBoundingClientRect()), 
        r = or(s), {
        ...
        setOffset: function(e, t, n) {
            ...
            var p, f, i = b(e), o = i.offset(), a = b.css(e, "top"), s = b.css(e, "left"), u = ("absolute" === r || "fixed" === r) && b.inArray("auto", [ a, s ]) > -1, l = {}, c = {};
...
+function(a) {
    ...
    function togglePushy() {
        body.toggleClass(pushyActiveClass), pushy.toggleClass(pushyClass), container.toggleClass(containerClass), 
        push.toggleClass(pushClass);
    }
    function openPushyFallback() {
        body.addClass(pushyActiveClass), pushy.animate({
            left: "0px"
    ...
    function closePushyFallback() {
        body.removeClass(pushyActiveClass), pushy.animate({
            left: "-" + menuWidth
        }, menuSpeed), container.animate({
            left: "0px"
        }, menuSpeed), push.animate({
    ...
    var pushy = $(".pushy"), body = $("body"), container = $("#container"), push = $(".push"), siteOverlay = $(".site-overlay"), pushyClass = "pushy-left pushy-open", pushyActiveClass = "pushy-active", containerClass = "container-push", pushClass = "push-push", menuBtn = $(".menu-btn, .pushy a"), menuSpeed = 200, menuWidth = pushy.width() + "px";
    if (cssTransforms3d = function() {
        var el = document.createElement("p"), supported = !1, transforms = {
            webkitTransform: "-webkit-transform",
            OTransform: "-o-transform",
            msTransform: "-ms-transform",
            MozTransform: "-moz-transform",
    ...
    }(), cssTransforms3d) menuBtn.click(function() {
        togglePushy();
        ...
        menuBtn.click(function() {
            state ? (openPushyFallback(), state = !1) : (closePushyFallback(), state = !0);
        }), siteOverlay.click(function() {
            state ? (openPushyFallback(), state = !1) : (closePushyFallback(), state = !0);
        });
    }
